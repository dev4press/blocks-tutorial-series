 ...
 */
function d4p_plugin_blocks_tutorial_series_autoload( $class ) {
	$path = dirname( __FILE__ ) . '/';
	$base = 'Dev4Press\\Plugin\\BlocksTutorialSeries\\';
...
spl_autoload_register( 'd4p_plugin_blocks_tutorial_series_autoload' );
